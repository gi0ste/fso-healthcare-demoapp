...
app.listen(appPort, err => {
    ...
    console.log(`HelperService: Booking Service: ${helper.bookingURL}`)
    console.log(`HelperService: Refund  Service: ${helper.refundUrl}`)
    console.log(`HelperService: Search  Service: ${helper.searchURL}`)
});
module.exports = app;